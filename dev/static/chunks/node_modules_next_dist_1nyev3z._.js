...
function createRuntimePrerenderSearchParams(underlyingSearchParams, workUnitStore, varyParamsAccumulator, isRuntimePrefetchable) {
    ...
    const searchParamsStages = _dynamicrenderingutils.RENDER_STAGES_BY_DATA_KIND.runtimeLinkData;
    const stage = isRuntimePrefetchable ? searchParamsStages.early : searchParamsStages.late;
    ...
    if (workUnitStore) {
        switch(workUnitStore.type){
            ...
            case 'request':
                ...
                ;
                const stagedRendering = undefined;
            default:
                workUnitStore;
        }
    }
        ...
        case 'prerender':
            {
                ...
                if (("TURBOPACK compile-time value", false) && stagedRendering && !isEmptyParams(underlyingParams)) //TURBOPACK unreachable
                ;
                break;
            }
        case 'prerender-client':
...
function createRuntimePrerenderParams(underlyingParams, optionalCatchAllParamName, workUnitStore, varyParamsAccumulator, isRuntimePrefetchable) {
    ...
    const paramsStages = _dynamicrenderingutils.RENDER_STAGES_BY_DATA_KIND.runtimeLinkData;
...
function createServerParamsInInstantValidation(underlyingParams, workStore, validationSamples, asyncApiPromises, isRuntimePrefetchable) {
    ...
    return (0, _dynamicrenderingutils.makePromiseFromTrigger)(isRuntimePrefetchable ? asyncApiPromises.earlySharedParamsParent : asyncApiPromises.sharedParamsParent, proxiedUnderlying);
}
...
//# sourceMappingURL=node_modules_next_dist_1nyev3z._.js.map